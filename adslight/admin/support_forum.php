...
echo "<label>" ._AM_ADSLIGHT_SUPPORTFORUM_CONTRYLANG. ":</label><img src=\"../images/flags/fr.png\" width=\"16\" height=\"11\" border=\"0\"><b>  Fran&#231;ais</b><br />";
...
//// Espagne ///
echo "<table width='100%' border='0' class='outer'><tr><td>";    
echo "<label>" ._AM_ADSLIGHT_SUPPORTFORUM_CONTRYLANG. ":</label><img src=\"../images/flags/es.png\" width=\"16\" height=\"11\" border=\"0\"><b>  Espa&#241;ol</b><br />";
...
//// Anglais ///
echo "<table width='100%' border='0' class='outer'><tr><td>";    
echo "<label>" ._AM_ADSLIGHT_SUPPORTFORUM_CONTRYLANG. ":</label><img src=\"../images/flags/uk.png\" width=\"16\" height=\"11\" border=\"0\"><b>  English</b><br />";
...
//// Allemand ///
echo "<table width='100%' border='0' class='outer'><tr><td>";    
echo "<label>" ._AM_ADSLIGHT_SUPPORTFORUM_CONTRYLANG. ":</label><img src=\"../images/flags/de.png\" width=\"16\" height=\"11\" border=\"0\"><b>  Deutsch</b><br />";
...
//// Bosnie ///
echo "<table width='100%' border='0' class='outer'><tr><td>";    
echo "<label>" ._AM_ADSLIGHT_SUPPORTFORUM_CONTRYLANG. ":</label><img src=\"../images/flags/ba.png\" width=\"16\" height=\"11\" border=\"0\"><b>  Bosanski</b><br />";
...
//// Italie ///
echo "<table width='100%' border='0' class='outer'><tr><td>";    
echo "<label>" ._AM_ADSLIGHT_SUPPORTFORUM_CONTRYLANG. ":</label><img src=\"../images/flags/unavailable.png\" width=\"16\" height=\"11\" border=\"0\"><b>  Italiano</b><br />";
...
//// Russie ///
echo "<table width='100%' border='0' class='outer'><tr><td>";    
echo "<label>" ._AM_ADSLIGHT_SUPPORTFORUM_CONTRYLANG. ":</label><img src=\"../images/flags/unavailable.png\" width=\"16\" height=\"11\" border=\"0\"><b>  &#1056;&#1091;&#1089;&#1089;&#1082;&#1080;&#1081;</b><br />";
echo "<label>" ._AM_ADSLIGHT_SUPPORTFORUM_WEBLINKS. ":</label> -<br />";
echo "<label>" ._AM_ADSLIGHT_SUPPORTFORUM_DESC. ":</label> -<br />";
...
//// Polonais ///
echo "<table width='100%' border='0' class='outer'><tr><td>";    
echo "<label>" ._AM_ADSLIGHT_SUPPORTFORUM_CONTRYLANG. ":</label><img src=\"../images/flags/unavailable.png\" width=\"16\" height=\"11\" border=\"0\"><b>  Polski</b><br />";
echo "<label>" ._AM_ADSLIGHT_SUPPORTFORUM_WEBLINKS. ":</label> -<br />";
echo "<label>" ._AM_ADSLIGHT_SUPPORTFORUM_DESC. ":</label> -<br />";
...
//// Portugais ///
echo "<table width='100%' border='0' class='outer'><tr><td>";    
echo "<label>" ._AM_ADSLIGHT_SUPPORTFORUM_CONTRYLANG. ":</label><img src=\"../images/flags/unavailable.png\" width=\"16\" height=\"11\" border=\"0\"><b>  Portugu&#234;s</b><br />";
echo "<label>" ._AM_ADSLIGHT_SUPPORTFORUM_WEBLINKS. ":</label> -<br />";
echo "<label>" ._AM_ADSLIGHT_SUPPORTFORUM_DESC. ":</label> -<br />";
