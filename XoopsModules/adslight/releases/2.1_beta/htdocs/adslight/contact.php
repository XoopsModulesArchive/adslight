...
if ($xoopsModuleConfig["adslight_use_captcha"] == '1') {
	...
	$lid = $_POST['id'];
	$result = $xoopsDB->query("select email, submitter, title, type, desctext, price, typeprice FROM  ".$xoopsDB->prefix("adslight_listing")." WHERE lid = ".mysql_real_escape_string($id)."");
