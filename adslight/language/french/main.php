...
define("_ADSLIGHT_TOBIG", "Est trop grand.<p> Utilisez la fonction <b>Page Pr&eacute;c&eacute;dente</b> pour revenir Ã  la forme un ajout d'un fichier");
...
define("_ADSLIGHT_NOMAIL", "Nous ne donnons pas aux utilisateurs les adresses e-mail des annonceurs.<br/>Pour les contacter par e-mail, utilisez le formulaire de contact sur notre site.<br/>Vous pouvez consulter l'annonce Ã  l'adresse Web suivante : ");
// modify.php //
...
define("_ADSLIGHT_THANKURATEITEM", "Merci de prendre le temps d'&eacute;valuer cette annonce ici, Ã  %s.");
...
define("_ADSLIGHT_REPLY_TITLE", "Messages reÃ§us pour l'annonce :");
