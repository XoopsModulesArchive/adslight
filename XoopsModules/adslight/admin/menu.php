...
$adminmenu[4]['link'] = "admin/admin.block.php";
...
$adminmenu[6]['title'] = _MI_ADSLIGHT_ADMENU10;
$adminmenu[6]['link'] = "../system/admin.php?fct=modulesadmin&op=update&module=adslight";
$adminmenu[6]['icon'] = "images/icons/refresh.png";
...
$adminmenu[8]['title'] = _MI_ADSLIGHT_ADMENU7;
$adminmenu[8]['link'] = "admin/about.php";
$adminmenu[8]['icon'] = "images/icons/info.png";
