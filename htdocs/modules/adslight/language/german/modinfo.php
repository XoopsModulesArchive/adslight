...
define("_MI_ADSLIGHT_MAXHIGH","Max. Höhe des Foto :");
...
define("_MI_ADSLIGHT_GPERM_G_ADD" , "kann hinzufügen" ) ;
...
define("_MI_ADSLIGHT_DELETE_NEWPOST_NOTIFY", "Gelöschte Kleinanzeigen");
...
define("_MI_ADSLIGHT_ACTIVE_REWRITEURL_DESC" ,"Aktivieren Sie das Umschreiben url, für eine bessere SEO.<br/>So installieren Sie das neu zu schreiben, ich danke Ihnen, um die Datei zu lesen README.txt");
...
define("_MI_ADSLIGHT_ADSLIGHT_USE_INDEX_CODE", "Verwenden Sie zusÃ¤tzlichen Code auf der Homepage");
define("_MI_ADSLIGHT_ADSLIGHT_USE_INDEX_CODE_DESC", "Die zusätzlichen Code Anzeige zwischen Inserate<br />auf der Startseite und die Kategorie Seite.<br /><br />Banner, Adsense-Code, etc. ...");
