...
define("_ADSLIGHT_NEWTOD","De nouvelles annonces ont &eacute;t&eacute; ajout&eacute;es dans cette cat&eacute;gorie aujourd'hui");
...
define("_ADSLIGHT_INTRO","<b>Vous pouvez ajouter votre(vos) petite(s) annonce(s) gratuitement.<br/> Il suffit de cliquer sur la cat&eacute;gorie dans laquelle vous d&eacute;sirez l'ajouter, <br/> Vous verrez un lien (Ajouter une petite annonce dans cette cat&eacute;gorie) .</B>");
...
define("_ADSLIGHT_WAIT","Petites annonces en attente d'&ecirc;tre approuv&eacute;es");
define("_ADSLIGHT_NO_CLA","Il n'y a pas d'annonce en attente d'&ecirc;tre approuv&eacute;e");
...
define("_ADSLIGHT_STOP2","Le d&eacute;lai pour l'inscription de votre petite annonce:");
...
define("_ADSLIGHT_THANK","Merci pour l'utilisation de notre service d'annonces class&eacute;es.");
...
define("_ADSLIGHT_WAIT3","Petite(s) annonces(s) en attente d'&ecirc;tre approuv&eacute;(es)");
...
define("_ADSLIGHT_NOANNINCAT","Il n'y a pas d'annonce dans cette cat&eacute;gorie");
...
define("_ADSLIGHT_ANNMODERATE","Votre annonce sera en attente d'approbation et une fois approuv&eacute;e, durera");
...
define("_ADSLIGHT_FORMEMBERS2","Publication des annonces est r&eacute;serv&eacute; aux membres <br/> S'il vous pla&icirc;t inscrivez-vous ou connectez-vous si vous &ecirc;tes d&eacute;j&agrave; membre.");
...
define("_ADSLIGHT_SELECTYPE","Selection de type d'annonces class&eacute;es:");
...
define("_ADSLIGHT_TOBIG","Est trop grand.<p> Utilisez la fonction <b>Page Pr&eacute;c&eacute;dente</b> pour revenir à la forme un ajout d'un fichier");
...
define("_ADSLIGHT_VALIDANN","Description de l'entreprise est n&eacute;cessaire.");
...
define("_ADSLIGHT_VALIDMSG","S'il vous pla&icirc;t corrigez ces erreurs pour enregister votre annonce.");
// display-image.php //
define("_ADSLIGHT_CLOSEF","Fermez cette fen&ecirc;tre");
// liste-p-f.php //
define("_ADSLIGHT_EXTRANN","Cette annonce est sur le site Web");
define("_ADSLIGHT_SENDTO","<b>Envoyer cette annonce &agrave; un ami</b><br><br>Vous pouvez envoyer l'annonce N&deg;�");
...
define("_ADSLIGHT_MAILFR","Email de l'ami:");
...
define("_ADSLIGHT_INTERESS","D'autres Petites annonces peuvent &ecirc;tre vues sur");
define("_ADSLIGHT_TEL2","T&eacute;l&eacute;phone:");
define("_ADSLIGHT_BYMAIL","Email:");
define("_ADSLIGHT_DISPO","Expire le");
define("_ADSLIGHT_NOMAIL","Nous ne donnons pas aux utilisateurs les adresses e-mail des annonceurs.<br/>Pour les contacter par e-mail, utilisez le formulaire de contact sur notre site.<br/>Vous pouvez consulter l'annonce à l'adresse Web suivante : ");
// modify.php //
...
define("_RETURNANN","Retour &agrave; la liste d'annonces class&eacute;es");
...
define("_ADSLIGHT_MODIFBEFORE","Les modifications apport&eacute;es &agrave; cette petite annonce doivent &ecirc;tre approuv&eacute;es par l'administrateur, et elle sera mise en file d'attente pour approbation");
define("_ADSLIGHT_SENDBY","Ajout&eacute;e par:");
define("_ADSLIGHT_NUMANNN","Petites annonces n°:");
...
define("_ADSLIGHT_TEXTAUTO","Le message envoie automatiquement les trois premiers champs, votre nom, votre e-mail et votre num&eacute;ro de t&eacute;l&eacute;phone, vous n'avez pas besoin de les entrer de nouveau dans votre message.");
...
define("_ADSLIGHT_VALIDMESS","Il est n&eacute;cessaire d'&eacute;crire un message.");
...
define("_ADSLIGHT_ENDMESS ","!!! Ne r&eacute;pondez pas &agrave; cet e-mail, il n'arriverait pas &agrave; l'exp&eacute;diteur. Si vous souhaitez r&eacute;pondre &agrave; l'exp&eacute;diteur, utilisez les coordonn&eacute;es ci-dessus. !!!");
...
define("_ADSLIGHT_NOMAIL2","Nous ne fournissons pas aux utilisateurs les adresses e-mail 'des annonceurs'. Pour les contacter par e-mail s'il vous pla&icirc;t utilisez le formulaire de contact sur notre site. Vous pouvez r&eacute;pondre &agrave; l'annonce &agrave; l'adresse suivante :");
define("_ADSLIGHT_MESSAGE_END","Fin du message.");
define("_ADSLIGHT_SECURE_SEND","Ce message a &eacute;t&eacute; envoy&eacute; par un syst&egrave;me s&eacute;curis&eacute; formulaire de contact, l'exp&eacute;diteur ne conna&icirc;t pas votre adresse email.");
// Message de fin //
...
define("_ADSLIGHT_PREMIUM_DAY","<b> Jours, si vous ne changez pas l'affichage du formulaire ci-dessous. </B>");
define("_ADSLIGHT_PREMIUM_LONG_HEAD","<b> Le lancement de votre annonce sera imm&eacute;diat </b>");
define("_ADSLIGHT_PREMIUM_MEMBER","<b> Puisque vous &ecirc;tes un membre utilisant l'offre PREMIUM, vous pouvez choisir la dur&eacute;e de votre annonce. <br/> <br/> Elle durera </b>");
define("_ADSLIGHT_PREMIUM_MODERATED_HEAD","<b> Votre annonce sera en attente d'approbation </b>");
...
define("_ADSLIGHT_THANKURATE","Merci d'avoir pris le temps d'&eacute;valuer cet utilisateur &agrave; %s.");
define("_ADSLIGHT_VOTEFROMYOU","Les contributions d'utilisateurs tels que vous, aideront d'autres visiteurs &agrave; mieux choisir leur annonce .");
define("_ADSLIGHT_VOTEONCE","S'il vous pla&icirc;t ne votez pas pour la m&ecirc;me ressource plus d'une fois.");
define("_ADSLIGHT_RATINGSCALE","L'&eacute;chelle est de 1 &agrave; 10, avec 1 &eacute;tant le plus faible et 10 &eacute;tant excellent.");
define("_ADSLIGHT_BEOBJECTIVE","S'il vous pla&icirc;t soyez objectif, si tout le monde re&ccedil;oit un 1 ou un 10, les notations ne seront pas tr&egrave;s utiles.");
...
define("_ADSLIGHT_VOTEONCE2","Ne votez pour l'annonce s&eacute;lectionn&eacute;e qu'une seule fois. <br/> Tous les votes sont identifi&eacute;s et examin&eacute;s.");
define("_ADSLIGHT_TOTALVOTES","Evaluation des Petites Annonces (total des votes: %s)");
define("_ADSLIGHT_USERTOTALVOTES","Votes d'utilisateurs enregistr&eacute;s (total des votes: %s)");
...
define("_ADSLIGHT_NOREGVOTES","Pas de vote d'utilisateurs enregistr&eacute;s");
define("_ADSLIGHT_NOUNREGVOTES","Pas de vote d'utilisateurs non enregistr&eacute;s");
...
define("_ADSLIGHT_THANKURATEUSER","Merci de prendre le temps d'&eacute;valuer cette ici &agrave; l'utilisateur %s.");
define("_ADSLIGHT_RATETHISITEM","Evaluez cette annonce");
define("_ADSLIGHT_THANKURATEITEM","Merci de prendre le temps d'&eacute;valuer cette annonce ici, à %s.");
...
define("_ADSLIGHT_YOUCANHAVE","En tant que membre Premium, vous pouvez avoir jusqu'&agrave; %s photo(s).");
...
define("_ADSLIGHT_YOUCANUPLOAD","Vous ne pouvez transf&eacute;rer que des fichiers jpg, d'un poids maximum de %s Ko");
...
define("_ADSLIGHT_NOCACHACA","D&eacute;sol&eacute;, vous n'avez pas acc&egrave;s &agrave; ce service");
...
define("_ADSLIGHT_NO_REPLIES","Il n'y a pas de r&eacute;ponse");
define("_ADSLIGHT_THANKS","Merci d'utiliser nos service de petites annonces");
...
define("_ADSLIGHT_ERROR_NOTIF","S'il s'agit d'une erreur ou si vous souhaitez ne plus recevoir ces notifications, s'il vous pla&icirc;t mettez &agrave; jour votre abonnement en visitant le lien ci-dessous:");
define("_ADSLIGHT_FOLLOW_LINK","Voici un lien vers la nouvelle annonce");
define("_ADSLIGHT_YOU_CAN_VIEW_BELOW","Vous pouvez voir l'annonce compl&egrave;te sur le lien ci-dessous");
...
define("_ADSLIGHT_NEW_WAITING","Il y a une nouvelle annonce en attente d'&ecirc;tre mod&eacute;r&eacute;.");
define("_ADSLIGHT_PLEASE_CHECK","S'il vous pla&icirc;t cliquez sur l'URL ci-dessous pour v&eacute;rifier cette annonce.");
define("_ADSLIGHT_ADMIN","Administrateur");
define("_ADSLIGHT_NEWAD","La nouvelle annonce est ci-dessous.");
define("_ADSLIGHT_NEED_TO_LOGIN","Vous aurez besoin d'&ecirc;tre connect&eacute;");
...
//report-abuse.php
define("_ADSLIGHT_REPORTSENDTO","<b>Signaler cette annonce:</b><br/><br/>Annonce n&deg; ");
define("_ADSLIGHT_REPORTANNSEND","Merci pour votre aide !!<br/>La petite annonce viens d'&ecirc;tre signal&eacute;e &agrave; un Admin.");
define("_ADSLIGHT_REPORTSUBJET","[Alerte] Une annonce ind�sirable sur ");
...
// R�serv�
define("_ADSLIGHT_RESERVED","R&eacute;serv&eacute;");
...
define("_ADSLIGHT_MAPS_TEXT","S&eacute;lectionnez une r&eacute;gion sur la carte<br />pour voir les annonces d'une r&eacute;gion.");

//viewads.php
define("_ADSLIGHT_NOCLAS","Il n'y a actuellement aucune annonce<br />dans cette cat&eacute;gorie...");
