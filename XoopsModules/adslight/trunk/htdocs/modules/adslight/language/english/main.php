...
define("_ADSLIGHT_DATE2","This Classified Ad was added");
define("_ADSLIGHT_SUPPRANN","Delete your Classified Ad");
define("_ADSLIGHT_MODIFANN","Modify your Classified Ad");
define("_ADSLIGHT_PHOTO","Photo");
define("_ADSLIGHT_VIEW","Viewed");
define("_ADSLIGHT_CONTACT","Contact");
define("_ADSLIGHT_BYMAIL2","Email");
define("_ADSLIGHT_STOP2","The listing period for your Classified Ad  :");
...
define("_ADSLIGHT_ADVERTISEMENTS","Classified Ad(s) active");
	//define("_ADSLIGHT_DISPO","available until");
define("_ADSLIGHT_MODADMIN","Change this Classified Ad (administrator)");
define("_ADSLIGHT_AND","and");
define("_ADSLIGHT_WAIT3","Classified Ad(s) waiting to be approved");
define("_ADSLIGHT_CREATBY","was written by");
define("_ADSLIGHT_FOR","for");
define("_ADSLIGHT_OF","of");
define("_ADSLIGHT_VIEW2","views");
define("_ADSLIGHT_VIEWANN2","See your Classified Ad");
...
define("_ADSLIGHT_INTERESS","Other Classified Ads can be seen at ");
